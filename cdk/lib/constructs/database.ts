...
export class Database extends Construct {
  ...
  constructor(scope: Construct, id: string, props?: DatabaseProps) {
    ...
    // Use customer-managed KMS key for enhanced security if provided
    const encryptionConfig = props?.kmsKey
      ? { encryption: TableEncryption.CUSTOMER_MANAGED, encryptionKey: props.kmsKey }
